...
#define CPS_B_17     0x08,0x0407,          __not_applicable__,          0x14,{0x12,0x10,0x0e,0x0c},0x0a, {0x08,0x10,0x02,0x24,0x24}   // the sf2 -> strider conversion needs 0x04 for the 2nd layer enable on one level, gfx confirmed to appear on the PCB, register at the time is 0x8e, so 0x10 is not set.
...
static const struct CPS1config cps1_config_table[]=
{
	...
	{"sf2ww17p",    CPS_B_17,     mapper_STF29,  0x36 },
	{"ffight17p",   CPS_B_17,     mapper_S224B },
	...
	{"sfzchh",      CPS_B_21_DEF, mapper_SFZ63B, 0x36 },
	{"ffighth",     CPS_B_04,     mapper_S224B },
