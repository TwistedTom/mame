...
public:
	...
	void ngmc161(machine_config &config);
...
WRITE16_MEMBER(neogeo_base_state::write_banksel)
{
  if (data > 0x04)
  {
    logerror("PC %06x: port write > 4: %02x\n", m_maincpu->pc(), data);
  }
  else
  {
    logerror("PC %06x: bankswitch: %02x\n", m_maincpu->pc(), data);
  }
...
void neogeo_base_state::set_slot_idx(int slot)
{
	if (slot != m_curr_slot)
	{
		...
		case NEOGEO_NGMC120:
			...
			break;
		case NEOGEO_NGMC161:
			space.install_read_handler(0x2fffe0, 0x2fffe1, read16sm_delegate(*m_slots[m_curr_slot], FUNC(neogeo_cart_slot_device::ram_r)));
			space.install_write_handler(0x2fff00, 0x2ffff7, write16s_delegate(*m_slots[m_curr_slot], FUNC(neogeo_cart_slot_device::ram_w)));
			break;
		}
		...
		{
			uint8_t *grom = memregion("cslot1:sprites")->base();
			uint32_t rom_size = memregion("cslot1:sprites")->bytes();
...
/****************************************
 ...
 Conversions
 -----------
 various late protected games
 should hopefully run on real progbk1+cha512y cart
 
****************************************/

/*
 3 versions:
 mslug3h, aes, mvs (later)
   BK1: no protection
   FIO: NEO-CMC(CMC42) - gfx encryption (C, S roms)
 mslug3, mslug3a, mvs (earlier)
   LBA: NEO-SMA - 68k code encryption (P roms)
   FIO: NEO-CMC(CMC42) - gfx encryption (C, S roms)
...
ROM_START( mslug3c )  // 256
	...
	ROM_LOAD( "256-v3.v3", 0x800000, 0x400000, CRC(0eaec17c) SHA1(c3ed613cc6993edd6fc0d62a90bcd85de8e21915) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "256-v4.v4", 0xc00000, 0x400000, CRC(9b4b22d4) SHA1(9764fbf8453e52f80aa97a46fb9cf5937ef15a31) ) /* TC5332204  32Mbit  28f320 */

	// decrypted gfx (kawaks)
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "256-c1d.c1", 0x0000000, 0x800000, CRC(3540398c) SHA1(0a96f2360eb26c66bf02bbc6f52230b55cc95e4e) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "256-c2d.c2", 0x0000001, 0x800000, CRC(bdd220f0) SHA1(f52851023f3bc120b05f622af0e0ab1bedc41604) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "256-c3d.c3", 0x1000000, 0x800000, CRC(bfaade82) SHA1(66b07e592c9a9b35567fe463496f8f75c32a7db9) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "256-c4d.c4", 0x1000001, 0x800000, CRC(1463add6) SHA1(4db91b46d6430da272d27d00a6dc0eb25949bea1) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "256-c5d.c5", 0x2000000, 0x800000, CRC(48ca7f28) SHA1(e903876be5fb4fa582c988d74c6bef1c3b9c7083) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "256-c6d.c6", 0x2000001, 0x800000, CRC(806eb36f) SHA1(a412a9cab80c326733dde7652d1db2a46afb3ebb) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "256-c7d.c7", 0x3000000, 0x800000, CRC(9395b809) SHA1(ca9ac9832017094eee3623f0b6c4c4b7b4f1374d) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "256-c8d.c8", 0x3000001, 0x800000, CRC(a369f9d4) SHA1(f8146ea80a1a23da7e7e04c88f778ee9abdfeb5c) ) /* TC5364205  64Mbit  28f640 */
ROM_END


/*
 2 versions: mslug4, mslug4h
   BK2: NEO-PCM2(SNK) - sound sample scrambling (V roms)
...
ROM_START( mslug4c )  // 263
	...
	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "263-v1d.v1", 0x000000, 0x400000, CRC(8cb5a9ef) SHA1(272ad312f8694acf9190ebf48d1c8a5fec73c130) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "263-v2d.v2", 0x400000, 0x400000, CRC(94217b1e) SHA1(c468a192e2ec0952a20cfd9e391cf6c12346efb3) ) /* TC5332204  32Mbit  28f320 */
...
/*
 1 version: mslugx
   EOP:  altera cpld - 68k code protection (P roms)
   512Y: no protection
 EOP board is unique to this game
 no cpld image is available
 p1 rom is from neogeo dev wiki, provided for repair of dead EOP boards (transfer roms to a BK1)
...
ROM_START( mslugxc )  // 250
	...
	ROM_REGION( 0xa00000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "250-v1.v1", 0x000000, 0x400000, CRC(c79ede73) SHA1(ebfcc67204ff9677cf7972fd5b6b7faabf07280c) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "250-v2.v2", 0x400000, 0x400000, CRC(ea9aabe1) SHA1(526c42ca9a388f7435569400e2f132e2724c71ff) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "250-v3.v3", 0x800000, 0x200000, CRC(2ca65102) SHA1(45979d1edb1fc774a415d9386f98d7cb252a2043) ) /* TC5316200  16Mbit  27c160 */

	ROM_REGION( 0x3000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "250-c1.c1", 0x0000000, 0x800000, CRC(09a52c6f) SHA1(c3e8a8ccdac0f8bddc4c3413277626532405fae2) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "250-c2.c2", 0x0000001, 0x800000, CRC(31679821) SHA1(554f600a3aa09c16c13c625299b087a79d0d15c5) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "250-c3.c3", 0x1000000, 0x800000, CRC(fd602019) SHA1(c56646c62387bc1439d46610258c755beb8d7dd8) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "250-c4.c4", 0x1000001, 0x800000, CRC(31354513) SHA1(31be8ea2498001f68ce4b06b8b90acbf2dcab6af) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "250-c5.c5", 0x2000000, 0x800000, CRC(a4b56124) SHA1(d41069856df990a1a99d39fb263c8303389d5475) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "250-c6.c6", 0x2000001, 0x800000, CRC(83e3e69d) SHA1(39be66287696829d243fb71b3fb8b7dc2bc3298f) ) /* TC5364205  64Mbit  28f640 */
ROM_END


/*
 2 versions: mslug5, mslug5h  both protected  (also dedicated pcb version)
   BK3S: NEO-PCM2(PM)+NEO-PVC - sound sample scrambling (V roms) + 68k code protection/encryption (P roms)
   FIO:  NEO-CMC(CMC50) - gfx encryption (C, S roms) + z80 code encryption (M rom)
...
ROM_START( mslug5c )  // 268
	...
	// decrypted sound samples (neoconv v2 + split into 4x 32Mbit)
	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "268-v1d.v1", 0x000000, 0x400000, CRC(f61daa9e) SHA1(c9a64c48a37d9fcbd83f34580f44330aab0a0601) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "268-v2d.v2", 0x400000, 0x400000, CRC(eeb7c926) SHA1(4d71f59948bdc5ed2e6daf101f16fd979e1ab193) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "268-v3d.v3", 0x800000, 0x400000, CRC(02fd519e) SHA1(6fbda5bf8dbf52bc110aba7b9d20b24bdc2fe0d7) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "268-v4d.v4", 0xc00000, 0x400000, CRC(d7c67794) SHA1(345dcbf76b25b2fbd10bcaf08ee395da0a52c5ce) ) /* TC5332204  32Mbit  28f320 */

	// decrypted gfx (kawaks), c5/c6 reduced
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "268-c1d.c1", 0x0000000, 0x800000, CRC(e8239365) SHA1(e0a75902a783110049730b66ad3cbccdd804bf62) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "268-c2d.c2", 0x0000001, 0x800000, CRC(89b21d4c) SHA1(862ac31ce9570529b33e6f58ada0ac867a442679) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "268-c3d.c3", 0x1000000, 0x800000, CRC(3cda13a0) SHA1(5d029c92688384eafd65ad711a2954d0b86a3163) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "268-c4d.c4", 0x1000001, 0x800000, CRC(9c00160d) SHA1(c612102f9cd288bba4c245b5855d795e4362b217) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "268-c5d.c5", 0x2000000, 0x200000, CRC(445d1a08) SHA1(2fe5805467c714e0fce98251867a7b1f26bf6ac4) ) /* 16Mbit  27c160 */
	ROM_LOAD16_BYTE( "268-c6d.c6", 0x2000001, 0x200000, CRC(f9aabed1) SHA1(27e8277f5be42c62b3e577150365be2adeb18a5a) ) /* 16Mbit  27c160 */
	ROM_LOAD16_BYTE( "268-c7d.c7", 0x3000000, 0x800000, CRC(c9f8c357) SHA1(7064224afa887f57245f5479b0b46228539a131b) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "268-c8d.c8", 0x3000001, 0x800000, CRC(fafc3eb9) SHA1(f4f73194cc7fd151be3ca2561f993b5be7628369) ) /* TC5364205  64Mbit  28f640 */
ROM_END


/*
 1 version: matrim
   BK2: NEO-PCM2(PM) - sound sample scrambling (V roms), additional 68k code (P roms) scrambling
   FIO: NEO-CMC(CMC50) - gfx encryption (C, S roms) + z80 code encryption (M rom)
...
ROM_START( matrimc )  // 266
	...
	// decrypted sound samples (neoconv v2 + split into 4x 32Mbit)
	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "266-v1d.v1", 0x000000, 0x400000, CRC(435f33cf) SHA1(8d7e4f416abcf3290ecc4ac93d856855793ca7f2) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "266-v2d.v2", 0x400000, 0x400000, CRC(945f8831) SHA1(6ac9bd41e0bb33601c82ebeb2aa5b1b8b91fada1) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "266-v3d.v3", 0x800000, 0x400000, CRC(e8362fcc) SHA1(42d558fd80cabe22a1c09a1fa75741afbcf46b7c) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "266-v4d.v4", 0xc00000, 0x400000, CRC(393c9a62) SHA1(0eaee0007557e59e64edcdbca229e6f776de9aef) ) /* TC5332204  32Mbit  28f320 */

	// decrypted gfx (kawaks)
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "266-c1d.c1", 0x0000000, 0x800000, CRC(0ab54c54) SHA1(31bca460462b8545b3e5264804987ab951e9b202) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "266-c2d.c2", 0x0000001, 0x800000, CRC(b834dd89) SHA1(579470839a8d23b2d22cf727d2b43c6c3c113e1f) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "266-c3d.c3", 0x1000000, 0x800000, CRC(f31d68d4) SHA1(a6b8aaf11d25f871b52e9626fe0e4ae0683c3c52) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "266-c4d.c4", 0x1000001, 0x800000, CRC(58cfb6e9) SHA1(106875db996ec29b0254b34f9d935c761cde20c4) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "266-c5d.c5", 0x2000000, 0x800000, CRC(f3c0e3fd) SHA1(3a2f14517617fb98a202ceec88d52891e1438c8e) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "266-c6d.c6", 0x2000001, 0x800000, CRC(b53c8dcf) SHA1(9f4b0bac92262e8c1c1055a70f13c7c326367f73) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "266-c7d.c7", 0x3000000, 0x800000, CRC(3c1fb02a) SHA1(43e170e6d48c01d8c323f9309f97e6038bab20d7) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "266-c8d.c8", 0x3000001, 0x800000, CRC(5ee31f80) SHA1(3cdd8037f5004df92f4c19ba0746c8bccb4e2473) ) /* TC5364205  64Mbit  28f640 */
ROM_END


/*
 2 versions: sengoku3, sengoku3a
   BK1: no protection
   FIO: NEO-CMC(CMC42) - gfx encryption (C, S roms)
*/
ROM_START( sengoku3c ) // 261
	...
	ROM_LOAD( "261-v4.v4", 0xc00000, 0x100000, CRC(c6eec9b1) SHA1(a82eb521c523c5ca5bbff8510f77be9d89cc06a1) ) /* 8Mbit  27c800 */

	// decrypted gfx (kawaks), could configure as 8x 27c322/28f320 instead
	ROM_REGION( 0x2000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "261-c1d.c1", 0x0000000, 0x800000, CRC(9af7cbca) SHA1(cf2fe3e5265861369f2878140ef33a6715b031aa) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "261-c2d.c2", 0x0000001, 0x800000, CRC(2a1f874d) SHA1(26923ec0bedba56f25e6222aa107b45ccb3def7b) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "261-c3d.c3", 0x1000000, 0x800000, CRC(5403adb5) SHA1(5614ee892e810dc49758f5985b3dc4f227e01b56) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "261-c4d.c4", 0x1000001, 0x800000, CRC(18926df6) SHA1(a4859c9166ef7abec1f3e6af3292051a63a81f93) ) /* TC5364205  64Mbit  28f640 */
ROM_END


/*
 2 versions: rotd, rotdh
   BK2: NEO-PCM2(SNK) - sound sample scrambling (V roms)
   FIO: NEO-CMC(CMC50) - gfx encryption (C, S roms) + z80 code encryption (M rom)
*/
ROM_START( rotdc ) // 264
	...
	// decrypted sfix (kawaks)
	NEO_SFIX_128K( "264-s1d.s1", CRC(c155d4ff) SHA1(cc20d4e30004ca82da2ba075c084d294c94651d0) ) /* TC531000  1Mbit  27c1000 */

	// decrypted z80 code (m1crypt)
	NEO_BIOS_AUDIO_128K( "264-m1d.m1", CRC(c5d36af9) SHA1(320739d0cfa6cc84455ae1f7b1f9cdab3c018933) ) /* TC531001  1Mbit  27c010 */

	// decrypted sound samples (neoconv v2 + split into 4x 32Mbit)
	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "264-v1d.v1", 0x000000, 0x400000, CRC(5c77a3fe) SHA1(3de61ff174d8b5b1a735666d3ed30554637e4b2d) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "264-v2d.v2", 0x400000, 0x400000, CRC(a9b7af14) SHA1(5e3c693634139fa8bbc0966af2873d1413cc13d9) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "264-v3d.v3", 0x800000, 0x400000, CRC(17aff92a) SHA1(cafbef0b1b20b53c9d18c6b727e1912f0c958382) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "264-v4d.v4", 0xc00000, 0x400000, CRC(bc6a091e) SHA1(434b0e7aeac14677c7ce95d119dc1dd7a41a85cb) ) /* TC5332204  32Mbit  28f320 */

	// decrypted gfx (kawaks), c5/c6 reduced
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "264-c1d.c1", 0x0000000, 0x800000, CRC(ec9d18c0) SHA1(83ebedae9655b6c64421cd131930b27d252853ec) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "264-c2d.c2", 0x0000001, 0x800000, CRC(b1069066) SHA1(0b4e2249efc782b572b589f72aadbd8007e8778c) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "264-c3d.c3", 0x1000000, 0x800000, CRC(7e636d49) SHA1(1ba15ddbce8369d7232cc1da3f833f6cb68fbc10) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "264-c4d.c4", 0x1000001, 0x800000, CRC(76892fda) SHA1(27416585973a6ec7b5721de1116c8700b38e3a4c) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "264-c5d.c5", 0x2000000, 0x80000,  CRC(8a9709a8) SHA1(af81b87587a81d9bc891070892974b9622b7c727) ) /* 4Mbit  27c400 */
	ROM_LOAD16_BYTE( "264-c6d.c6", 0x2000001, 0x80000,  CRC(d780ff92) SHA1(1f5e75e9db41c8b70d5557dc784bd982393468df) ) /* 4Mbit  27c400 */
	ROM_LOAD16_BYTE( "264-c7d.c7", 0x3000000, 0x800000, CRC(edda4baf) SHA1(3f53eb50fd9ec9e9ee05eee050885c07023b6d53) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "264-c8d.c8", 0x3000001, 0x800000, CRC(82b1ba22) SHA1(b4ad715807f2c15fc06945f0bcb475c3698cf089) ) /* TC5364205  64Mbit  28f640 */
ROM_END


/*
 1 version: svc  (also dedicated pcb version)
   BK3R: NEO-PCM2(PM)+NEO-PVC - sound sample scrambling (V roms) + 68k code protection/encryption (P roms)
   FIO:  NEO-CMC(CMC50) - gfx encryption (C, S roms) + z80 code encryption (M rom)
 various bootlegs: svcboot, svcplus, svcplusa, svcsplus
...
ROM_START( svcc )  // 269
	...
	ROM_LOAD16_BYTE( "269-c3d.c3", 0x1000000, 0x800000, CRC(f4d4ab2b) SHA1(a19788435173540469fe5d07429a83dde6d701a0) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "269-c4d.c4", 0x1000001, 0x800000, CRC(a69d523a) SHA1(98d8dac2e40f71b5b8426d3c77476a0a20783181) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "269-c5d.c5", 0x2000000, 0x800000, CRC(ba2a7892) SHA1(eed45e1330dcc9f610598dc53977bf3a81dd161a) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "269-c6d.c6", 0x2000001, 0x800000, CRC(37371ca1) SHA1(8aaa1b9ea34470085d9944c9ad64cfb0ffe09859) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "269-c7d.c7", 0x3000000, 0x800000, CRC(5595b6cc) SHA1(9d6cc70f435401355b885475ccc3864825887656) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "269-c8d.c8", 0x3000001, 0x800000, CRC(b17dfcf9) SHA1(46af296b12831ee40355f52d2c316f609557d6df) ) /* TC5364205  64Mbit  28f640 */
ROM_END


/*
 3 version: samsho5, samsho5a, samsho5h
   BK2R: NEO-PCM2(PM) - sound sample scrambling (V roms), additional 68k code (P roms) scrambling
   FIO: NEO-CMC(CMC50) - gfx encryption (C, S roms) + z80 code encryption (M rom)
 bootleg: samsho5b
...
ROM_START( samsho5c )  // 270
	...
	// decrypted sound samples (neoconv v2 + split into 4x 32Mbit)
	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "270-v1d.v1", 0x000000, 0x400000, CRC(240c6742) SHA1(8de38508ff914888b23f6fac839b593b22c6232d) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "270-v2d.v2", 0x400000, 0x400000, CRC(7d096473) SHA1(9ab3992b2607f847c3ad9d37de4567d60b526aa4) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "270-v3d.v3", 0x800000, 0x400000, CRC(980e4cc7) SHA1(e13f1baf60343af109d90ab73c069c340354d1c0) ) /* TC5332204  32Mbit  28f320 */
	ROM_LOAD( "270-v4d.v4", 0xc00000, 0x400000, CRC(f8fd316f) SHA1(33cc44ad6c224d83dde99e77c05da13ffcf39fb4) ) /* TC5332204  32Mbit  28f320 */

	// decrypted gfx (kawaks)
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "270-c1d.c1", 0x0000000, 0x800000, CRC(9adec562) SHA1(069d73384dc320c38db420c8b04db86ac0b76101) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "270-c2d.c2", 0x0000001, 0x800000, CRC(ac0309e5) SHA1(9795fb2fa9eea617ec25656cfa9cd507899ec4fe) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "270-c3d.c3", 0x1000000, 0x800000, CRC(82db9dae) SHA1(0206e1cc2c5f0fbbc074a93add5a44f645951d0c) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "270-c4d.c4", 0x1000001, 0x800000, CRC(f8041153) SHA1(55705c725aff949e668c24b23e2e4cdb4ecf78ae) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "270-c5d.c5", 0x2000000, 0x800000, CRC(e689d62d) SHA1(001a59bb1bb14f263d16f8b7e977cd49e44e265a) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "270-c6d.c6", 0x2000001, 0x800000, CRC(a993bdcf) SHA1(d15980afe6d4b33506918186a2efc3f51b2347ca) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "270-c7d.c7", 0x3000000, 0x800000, CRC(707d56a0) SHA1(303ecc621305c8fbeece8d599f9382fe82d191ee) ) /* TC5364205  64Mbit  28f640 */
	ROM_LOAD16_BYTE( "270-c8d.c8", 0x3000001, 0x800000, CRC(f5903adc) SHA1(64f867a4e9d23302aa1e884f8fad7872ee347a86) ) /* TC5364205  64Mbit  28f640 */
ROM_END
...
ROM_START( ngmc120 )
	...
	ROM_REGION( 0x20000, "audiobios", 0 )
	ROM_LOAD( "sm1.sm1", 0x00000, 0x20000, CRC(94416d67) SHA1(42f9d7ddd6c0931fd64226a60dc73602b2819dcf) )
	ROM_REGION( 0x1000, "cslot1:audiocpu", 0 )
	ROM_FILL( 0x0000, 0x1000, 0x76 )

	ROM_REGION( 0x1000, "cslot1:ymsnd", 0 )
	ROM_FILL( 0x0000, 0x1000, 0xff )

	ROM_REGION( 0x1000, "cslot1:sprites", 0 )
	ROM_FILL( 0x0000, 0x1000, 0xff )
ROM_END
...
ROM_START( ngmc161 )
	...
	NEO_SFIX_128K( "menu-s1.bin", CRC(9687a9fe) SHA1(b5ff8eae9f29bf9d223f7d43488216b2638132d5) )
...
void mvs_led_state::ngmc161(machine_config &config)
{
	mv1_fixed(config);
	cartslot_fixed(config, "ngmc161");
}
...
GAME( 2019, mslug4c,    neogeo,   neobase,   neogeo,    mvs_led_state, empty_init, ROT0, "Mega / Playmore", "Metal Slug 4 (NGM-2630) (PROGBK1/CHA512Y Conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 2019, mslugxc,    neogeo,   neobase,   neogeo,    mvs_led_state, empty_init, ROT0, "SNK", "Metal Slug X - Super Vehicle-001 (NGM-2500 ~ NGH-2500) (PROGBK1/CHA512Y Conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 2019, mslug5c,    neogeo,   neobase,   neogeo,    mvs_led_state, empty_init, ROT0, "SNK Playmore", "Metal Slug 5 (NGM-2680) (PROGBK1/CHA512Y Conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 2019, matrimc,    neogeo,   neobase,   neogeo,    mvs_led_state, empty_init, ROT0, "Noise Factory / Atlus", "Matrimelee / Shin Gouketsuji Ichizoku Toukon (NGM-2660 ~ NGH-2660) (PROGBK1/CHA512Y Conversion)", MACHINE_SUPPORTS_SAVE )
GAME( 2019, sengoku3c,  neogeo,   neobase,   neogeo,    mvs_led_state, empty_init, ROT0, "Noise Factory / SNK", "Sengoku 3 / Sengoku Densho 2001 (set 1) (PROGBK1/CHA512Y Conversion)" , MACHINE_SUPPORTS_SAVE )
...
GAME( 2020, ngmc161,    neogeo,   ngmc161,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "161-in-1 multi-cart (chinese)", MACHINE_SUPPORTS_SAVE )
GAME( 2020, ngmc161e,   ngmc161,  ngmc161,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "161-in-1 multi-cart (english)", MACHINE_SUPPORTS_SAVE )
...
ROM_START( svcpmc )  // 001 SNK vs. Capcom +
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "svcpmc_0.bin", 0x000000, 0x100000, CRC(d3aa945a) SHA1(8083d6a56c6b0f60b21a54a93ca6136f9bbc6571) )
	ROM_LOAD( "svcpmc_1.bin", 0x100000, 0x100000, CRC(566368a5) SHA1(6957a4438a8267d42eec3c896df9bccbb86eae54) )
	ROM_LOAD( "svcpmc_2.bin", 0x200000, 0x100000, CRC(df1fbfc6) SHA1(337561b656287953305e54f5b7f409e115c8a755) )
	ROM_LOAD( "svcpmc_3.bin", 0x300000, 0x100000, CRC(12785af8) SHA1(60d09d608a4d37f928a91053c7b6bdd8449b641e) )
	ROM_LOAD( "svcpmc_4.bin", 0x400000, 0x100000, CRC(7fa7ccfc) SHA1(61e378347e1a8fba223ea3df1273ecf0e42f5c89) )
	ROM_LOAD( "svcpmc_5.bin", 0x500000, 0x100000, CRC(bc925a35) SHA1(0235c7e06dbab4f87a9ded57ebfa6a0fad6a793f) )
	
	NEO_SFIX_128K( "svcpmc_s.bin", CRC(aaef740c) SHA1(d7ae898ac93f78b19b125e98659dcfd9ee3179b2) )

	NEO_BIOS_AUDIO_128K( "svcpmc_m.bin", CRC(4e81642e) SHA1(75719f7dc0f051977ea685e8570fbda622fa191e) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "svcpmc_v1.bin", 0x000000, 0x400000, CRC(e7203930) SHA1(c6753df1db87d223ee39ffac920da449127dbcdf) )  // bad
	ROM_LOAD( "svcpmc_v2.bin", 0x400000, 0x400000, CRC(675159c3) SHA1(c3a4f6db61dfab5bc31bfe94e1c3915676347031) )  // bad
	ROM_LOAD( "svcpmc_v3.bin", 0x800000, 0x400000, CRC(f8810665) SHA1(fc1e94629a5124076959938257a80d04b2e871eb) )  // bad
	ROM_LOAD( "svcpmc_v4.bin", 0xc00000, 0x400000, CRC(b57b4ea3) SHA1(873dc7f5eae687bc70af01ea310e935287de0ebf) )  // bad

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "svcpmc_c1.bin", 0x0000000, 0x800000, CRC(465d473b) SHA1(0b2be2b2657c2ae021ec91515d1d6306179751d5) )
	ROM_LOAD16_BYTE( "svcpmc_c2.bin", 0x0000001, 0x800000, CRC(3eb28f78) SHA1(df1b096fe95796db1515b69f74266ed13dd9ee56) )
	ROM_LOAD16_BYTE( "svcpmc_c3.bin", 0x1000000, 0x800000, CRC(f4d4ab2b) SHA1(a19788435173540469fe5d07429a83dde6d701a0) )
	ROM_LOAD16_BYTE( "svcpmc_c4.bin", 0x1000001, 0x800000, CRC(a69d523a) SHA1(98d8dac2e40f71b5b8426d3c77476a0a20783181) )
	ROM_LOAD16_BYTE( "svcpmc_c5.bin", 0x2000000, 0x800000, CRC(ba2a7892) SHA1(eed45e1330dcc9f610598dc53977bf3a81dd161a) )
	ROM_LOAD16_BYTE( "svcpmc_c6.bin", 0x2000001, 0x800000, CRC(37371ca1) SHA1(8aaa1b9ea34470085d9944c9ad64cfb0ffe09859) )
	ROM_LOAD16_BYTE( "svcpmc_c7.bin", 0x3000000, 0x800000, CRC(56ac5fb9) SHA1(74cb0d57060d25e35f76a9820f607633bd1b9c2c) )  // bad
	ROM_LOAD16_BYTE( "svcpmc_c8.bin", 0x3000001, 0x800000, CRC(de99e613) SHA1(f28c6af4a31a937e5b441d4b860e3ccca725f27a) )  // bad
ROM_END

ROM_START( svcrmc )  // 002 SNK vs. Capcom Rmx
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "svcrmc_0.bin", 0x000000, 0x100000, CRC(03c918c6) SHA1(f54e40c54c6fe2df85c846b027e1dd1787f2d880) )
	ROM_LOAD( "svcrmc_1.bin", 0x100000, 0x100000, CRC(566368a5) SHA1(6957a4438a8267d42eec3c896df9bccbb86eae54) )
	ROM_LOAD( "svcrmc_2.bin", 0x200000, 0x100000, CRC(ff01d6cc) SHA1(5428cf816160f66bcdb7bd7c29ddd8abf9f02400) )
	ROM_LOAD( "svcrmc_3.bin", 0x300000, 0x100000, CRC(c6432694) SHA1(aac98ffc06bcf3710df67195a7d2bec08a3c5008) )
	ROM_LOAD( "svcrmc_4.bin", 0x400000, 0x100000, CRC(f49f908d) SHA1(0249515aad08c615c3a46fee7ffff9d007b2e78a) )
	ROM_LOAD( "svcrmc_5.bin", 0x500000, 0x100000, CRC(bc925a35) SHA1(0235c7e06dbab4f87a9ded57ebfa6a0fad6a793f) )
...
ROM_START( svcspmc )  // 003 SNK vs. Capcom Super Plus
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "svcspmc_0.bin", 0x000000, 0x100000, CRC(249ee836) SHA1(3563c0950b65c672271d31fdc9b3805d9e9cb0cf) )
	ROM_LOAD( "svcspmc_1.bin", 0x100000, 0x100000, CRC(566368a5) SHA1(6957a4438a8267d42eec3c896df9bccbb86eae54) )
	ROM_LOAD( "svcspmc_2.bin", 0x200000, 0x100000, CRC(df1fbfc6) SHA1(337561b656287953305e54f5b7f409e115c8a755) )
	ROM_LOAD( "svcspmc_3.bin", 0x300000, 0x100000, CRC(a0f41c3a) SHA1(f13bb9db218bbe61db6ea85f15aa77f4da60c084) )
	ROM_LOAD( "svcspmc_4.bin", 0x400000, 0x100000, CRC(7fa7ccfc) SHA1(61e378347e1a8fba223ea3df1273ecf0e42f5c89) )
	ROM_LOAD( "svcspmc_5.bin", 0x500000, 0x100000, CRC(bc925a35) SHA1(0235c7e06dbab4f87a9ded57ebfa6a0fad6a793f) )

	NEO_SFIX_128K( "svcspmc_s.bin", CRC(0b6fd62e) SHA1(ebeb80634c91c249412f75c99be93861183d06b9) )
...
ROM_START( kof2003mc )  // 036 The King of Fighters 2003
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "kof2003mc_0.bin", 0x000000, 0x100000, CRC(283e729a) SHA1(641edb14b75f97ac20515ccb1f073943f98ee793) )
	ROM_LOAD( "kof2003mc_1.bin", 0x100000, 0x100000, CRC(b8e58f7a) SHA1(bb2042184c2325a0d1a2da386b82d4251a5be37e) )
	ROM_LOAD( "kof2003mc_2.bin", 0x200000, 0x100000, CRC(2737f502) SHA1(8b6da143c9a8d4ade6a187f6b73548ec0bd4e874) )
	ROM_LOAD( "kof2003mc_3.bin", 0x300000, 0x100000, CRC(01192324) SHA1(9d3cfd4b23b8067f70ceba66805bc09b123be9ad) )
	ROM_LOAD( "kof2003mc_4.bin", 0x400000, 0x100000, CRC(84b7e3e7) SHA1(7a3e97b22cae39f09ad4d7508e1f48af9e1a2e06) )
	ROM_LOAD( "kof2003mc_5.bin", 0x500000, 0x100000, CRC(c8c9684e) SHA1(977c3537435f09e581da192d2b79057abe84c867) )
	ROM_LOAD( "kof2003mc_6.bin", 0x600000, 0x100000, CRC(30c8317f) SHA1(8c9dc053b0288f45556a53208039f0845eddd123) )
	ROM_LOAD( "kof2003mc_7.bin", 0x700000, 0x100000, CRC(c6a92192) SHA1(4468a4fd033dd6b66225702ea5b367635b161387) )

	NEO_SFIX_128K( "kof2003mc_s.bin", CRC(3f002dc2) SHA1(c9c28377c7b72452c6b2ed5c222673f1df2bca68) )

	NEO_BIOS_AUDIO_128K( "kof2003mc_m.bin", CRC(3a4969ff) SHA1(2fc107a023a82053a8df63025829bcf12cee9610) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "kof2003mc_v1.bin", 0x000000, 0x400000, CRC(d2b8aa5e) SHA1(498f0556c1de56822141f8043f1ce20444f4ed0a) )
	ROM_LOAD( "kof2003mc_v2.bin", 0x400000, 0x400000, CRC(71956ee2) SHA1(a890941e60db358cf45b58909f4719f4826f3bb1) )
	ROM_LOAD( "kof2003mc_v3.bin", 0x800000, 0x400000, CRC(ddbbb199) SHA1(0eea4b064bdb8daa03c354fe0a0aa27c4c665bda) )
	ROM_LOAD( "kof2003mc_v4.bin", 0xc00000, 0x400000, CRC(01b90c4f) SHA1(387164aa1995d8c11ed939b3afbc294d86d2e27f) )

	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "kof2003mc_c1.bin", 0x0000000, 0x800000, CRC(e42fc226) SHA1(1cd9364993e141facdcdd53ec2277df7b275d8a7) )
	ROM_LOAD16_BYTE( "kof2003mc_c2.bin", 0x0000001, 0x800000, CRC(1b5e3b58) SHA1(0eb254477a9479541291e43e415310852a0f0bed) )
	ROM_LOAD16_BYTE( "kof2003mc_c3.bin", 0x1000000, 0x800000, CRC(d334fdd9) SHA1(1efe30b4f56a55e25ab518cf6999de797b5e407c) )
	ROM_LOAD16_BYTE( "kof2003mc_c4.bin", 0x1000001, 0x800000, CRC(0d457699) SHA1(ec73d0c9fc7094d0ac6c0986a6e07cde25893e57) )
	ROM_LOAD16_BYTE( "kof2003mc_c5.bin", 0x2000000, 0x800000, CRC(8a91aae4) SHA1(802f4baacf801646be1ef686e105b2e867a6a5df) )
	ROM_LOAD16_BYTE( "kof2003mc_c6.bin", 0x2000001, 0x800000, CRC(9f8674b8) SHA1(65964f40b2227d020023fb436579927e65807dcd) )
	ROM_LOAD16_BYTE( "kof2003mc_c7.bin", 0x3000000, 0x800000, CRC(374ea523) SHA1(613827d72c6181f3e08353750c9af0c4dbad020b) )
	ROM_LOAD16_BYTE( "kof2003mc_c8.bin", 0x3000001, 0x800000, CRC(75211f4d) SHA1(d82f044e816ee539ff131d9c931200c818d34cd0) )
ROM_END

ROM_START( sonicwi2mc )  // 048 Aero Fighters 2
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "sonicwi2mc_0.bin", 0x000000, 0x100000, CRC(9e9379cc) SHA1(cf2897ffca725f8c363c1c1e57addf8d0fefd1ff) )
	ROM_LOAD( "sonicwi2mc_1.bin", 0x100000, 0x100000, CRC(82f40dad) SHA1(9ce0accce607d27a8281cad2d7ebd76206614b40) )
...
ROM_START( sonicwi3mc )  // 049 Aero Fighters 3
	ROM_REGION( 0x200000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	//ROM_LOAD( "sonicwi3mc_0.bin", 0x000000, 0x100000, CRC(030bb6c4) SHA1(f98481e0b9b0b2e36d44e7a5edfe57058793fcde) )
	//ROM_LOAD( "sonicwi3mc_1.bin", 0x100000, 0x100000, CRC(c6fee0d2) SHA1(238ecac5ea69f31e125f2238e588319efffac38c) )
	ROM_LOAD( "sonicwi3mc_0_fixed.bin", 0x000000, 0x100000, CRC(bd5a7f93) SHA1(6f71598491b64de87f5233bd02bc7f6b11826eb0) )
	ROM_LOAD( "sonicwi3mc_1_fixed.bin", 0x100000, 0x100000, CRC(9318b58e) SHA1(9fe56e7ce21c7c6f274e30c77879e9e0dceca868) )
...
ROM_START( samsh5spmc )  // 076 Samurai Shodown V Special
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "samsh5spmc_0.bin", 0x000000, 0x100000, CRC(7d71e397) SHA1(60ff13ebd7966a01f0cfc14ac1792722465e7b44) )
	ROM_LOAD( "samsh5spmc_1.bin", 0x100000, 0x100000, CRC(4339cdfe) SHA1(a41c1e64f3db4223f9227291662b182f589c3081) )
	ROM_LOAD( "samsh5spmc_2.bin", 0x200000, 0x100000, CRC(4edc6bb1) SHA1(e07e0217f14f585ea8a63fd398ecfc45777287fe) )
	ROM_LOAD( "samsh5spmc_3.bin", 0x300000, 0x100000, CRC(221adc7f) SHA1(c98a7e54490b11eae9fcb0d0f50181421e89fff1) )
	ROM_LOAD( "samsh5spmc_4.bin", 0x400000, 0x100000, CRC(8f2de9a6) SHA1(6fcc290cad42ffa12fd70322ed9d094083713236) )
	ROM_LOAD( "samsh5spmc_5.bin", 0x500000, 0x100000, CRC(80a2133c) SHA1(ceb73d045c99b8ab614a6deb0658eef7ad105229) )
	ROM_LOAD( "samsh5spmc_6.bin", 0x600000, 0x100000, CRC(bd8fe7ea) SHA1(389689885fcf6e6421d56d13612467167042c874) )
	ROM_LOAD( "samsh5spmc_7.bin", 0x700000, 0x100000, CRC(e3a60ffc) SHA1(b13ef8f921661c32a3938b2579ba9efa80c2b146) )

	NEO_SFIX_128K( "samsh5spmc_s.bin", CRC(c297f973) SHA1(b31af6b51e7536b538cd7eb3542c631c6327e826) )

	NEO_BIOS_AUDIO_128K( "samsh5spmc_m.bin", CRC(b5abda07) SHA1(682662887442d46790b5cc171982a8a7454156b7) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd", 0 )
	ROM_LOAD( "samsh5spmc_v1.bin", 0x000000, 0x400000, CRC(32156cfe) SHA1(6478c7a4f226ce3252556ecc039b611c15e65a6c) )
	ROM_LOAD( "samsh5spmc_v2.bin", 0x400000, 0x400000, CRC(0e46d2f8) SHA1(b8b0838124ea29f73f31e08d5cced8797cea75b1) )
	ROM_LOAD( "samsh5spmc_v3.bin", 0x800000, 0x400000, CRC(3f0f7554) SHA1(2581e297725f3b950b59e9086ac5569171da6140) )
	ROM_LOAD( "samsh5spmc_v4.bin", 0xc00000, 0x400000, CRC(ad8fabb4) SHA1(cebe3b7306e1431ebb99df13bfc2270b1d3ba1ff) )
	
	ROM_REGION( 0x4000000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "samsh5spmc_c1.bin", 0x0000000, 0x800000, CRC(8548097e) SHA1(99177f64039d2914fa4ebd4afc7eb0fbf4ffe0af) )
	ROM_LOAD16_BYTE( "samsh5spmc_c2.bin", 0x0000001, 0x800000, CRC(8c1b48d0) SHA1(3f20288ed369e6276cfaedff7e9703d4ea1cf6f6) )
	ROM_LOAD16_BYTE( "samsh5spmc_c3.bin", 0x1000000, 0x800000, CRC(96ddb28c) SHA1(7ebe5166d279c0d3efef65618d015b4ea13f2c49) )
	ROM_LOAD16_BYTE( "samsh5spmc_c4.bin", 0x1000001, 0x800000, CRC(99ef7a0a) SHA1(9ac3ef339bc1d6e3482e0b32d40b259ec2b44fc1) )
	ROM_LOAD16_BYTE( "samsh5spmc_c5.bin", 0x2000000, 0x800000, CRC(772e8b1e) SHA1(8de4898bbd8ede593763bfa93bbf26492492d23a) )
	ROM_LOAD16_BYTE( "samsh5spmc_c6.bin", 0x2000001, 0x800000, CRC(5fff21fc) SHA1(5d0a23a41f5277ab09fd11f227be35f1713a4b4f) )
	ROM_LOAD16_BYTE( "samsh5spmc_c7.bin", 0x3000000, 0x800000, CRC(9ac56a0e) SHA1(ea4ffec3fe2e58df16b40fdf33e1708680010414) )
	ROM_LOAD16_BYTE( "samsh5spmc_c8.bin", 0x3000001, 0x800000, CRC(cfde7aff) SHA1(25185f471dd35e5d388b75b83d8652085cd5e17d) )
ROM_END

ROM_START( pbobblenmc )  // 104 Puzzle Bobble
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "pbobblenmc_0.bin", 0x000000, 0x100000, CRC(9f970955) SHA1(3510a17d3efced29478f00e1fbc63711c6cc7517) )
	...
	ROM_REGION( 0x380000, "cslot1:ymsnd", 0 )
	/* 0x000000-0x1fffff empty */
	ROM_LOAD( "pbobblenmc_v1.bin", 0x200000, 0x100000, CRC(cc48f283) SHA1(94139af53bb045a93f4543b39e7a50883964b936) )  // bad
	//ROM_LOAD( "pbobblenmc_v2.bin", 0x300000, 0x080000, CRC(00000000) SHA1(0000000000000000000000000000000000000000) ) // missing

	ROM_REGION( 0x100000, "cslot1:sprites", 0 )
	ROM_LOAD16_BYTE( "d96-02.c5", 0x000000, 0x080000, CRC(e89ad494) SHA1(69c9ea415773af94ac44c48af05d55ada222b138) )
	ROM_LOAD16_BYTE( "d96-03.c6", 0x000001, 0x080000, CRC(4b42d7eb) SHA1(042ae50a528cea21cf07771d3915c57aa16fd5af) )
ROM_END

ROM_START( mutnatmc )  // 117 Mutation Nation
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "mutnatmc_0.bin", 0x000000, 0x100000, CRC(40c074c9) SHA1(c2fae4e33e1d6463e8a56c118ac356411e0f5fda) )
...
ROM_START( alpham2mc )  // 119 Alpha Mission II
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "alpham2mc_0.bin", 0x000000, 0x100000, CRC(aa836969) SHA1(ac11937141f94261898217c922a730c03cd5cb4c) )
...
ROM_START( magdrop2mc )  // 134 Magical Drop II
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	//ROM_LOAD( "magdrop2mc_0.bin", 0x000000, 0x100000, CRC(3f98989a) SHA1(fbb4ec341fb1dfb97443a8abdcad11bfbd3e189c) )
	ROM_LOAD( "magdrop2mc_0_fixed.bin", 0x000000, 0x100000, CRC(8e22441a) SHA1(26fd56e8967ee741ca0a669c55fc8062177ef6d5) )
...
ROM_START( kotmmc )  // 146 King of the Monsters
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "kotmmc_0.bin", 0x000000, 0x100000, CRC(c42151cc) SHA1(289d1d8ce7467b1ea47c9f5394256335d9b23107) )
...
ROM_START( bjourneymc )  // 148 Blue's Journey
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "bjourneymc_0.bin", 0x000000, 0x100000, CRC(8c8ab39a) SHA1(7ad734b79153290b76998629eb6ef6d0134e1a60) )

	NEO_SFIX_128K( "022-s1.s1", CRC(843c3624) SHA1(dbdf86c193b7c1d795f8c21f2c103c1d3e18abbe) )

	NEO_BIOS_AUDIO_128K( "bjourneymc_m.bin", CRC(f955306e) SHA1(735779d992e799d599fbf552cd3c69f53a255694) )
...
ROM_START( kof2003cmc )  // 153 The King of Fighters 2003 Change
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "kof2003cmc_0.bin", 0x000000, 0x100000, CRC(4efda392) SHA1(1246e7ee8345da3aa2ea6976977a5bc332be4c36) )
	ROM_LOAD( "kof2003cmc_1.bin", 0x100000, 0x100000, CRC(b8e58f7a) SHA1(bb2042184c2325a0d1a2da386b82d4251a5be37e) )
	ROM_LOAD( "kof2003cmc_2.bin", 0x200000, 0x100000, CRC(2737f502) SHA1(8b6da143c9a8d4ade6a187f6b73548ec0bd4e874) )
	ROM_LOAD( "kof2003cmc_3.bin", 0x300000, 0x100000, CRC(01192324) SHA1(9d3cfd4b23b8067f70ceba66805bc09b123be9ad) )
	ROM_LOAD( "kof2003cmc_4.bin", 0x400000, 0x100000, CRC(84b7e3e7) SHA1(7a3e97b22cae39f09ad4d7508e1f48af9e1a2e06) )
	ROM_LOAD( "kof2003cmc_5.bin", 0x500000, 0x100000, CRC(c8c9684e) SHA1(977c3537435f09e581da192d2b79057abe84c867) )
	ROM_LOAD( "kof2003cmc_6.bin", 0x600000, 0x100000, CRC(30c8317f) SHA1(8c9dc053b0288f45556a53208039f0845eddd123) )
	ROM_LOAD( "kof2003cmc_7.bin", 0x700000, 0x100000, CRC(c6a92192) SHA1(4468a4fd033dd6b66225702ea5b367635b161387) )
...
ROM_START( magdrop3mc )  // 155 Magical Drop III
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	//ROM_LOAD( "magdrop3mc_0.bin", 0x000000, 0x100000, CRC(f8f0f782) SHA1(c8d882c7ba7295ca2a6404a9de8407cf4365833a) )
	ROM_LOAD( "magdrop3mc_0_fixed.bin", 0x000000, 0x100000, CRC(494a2b02) SHA1(ba36d6ab0f1a4d9bf71c7782e422ed488c99344b) )
...
ROM_START( wjammersmc )  // --- Windjammers (unused)
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	//ROM_LOAD( "wjammersmc_0.bin", 0x000000, 0x100000, CRC(56657136) SHA1(fe9d6af23e030c8573b2ab64951e7430c25e3545) )
	ROM_LOAD( "wjammersmc_0_fixed.bin", 0x000000, 0x100000, CRC(e7dfadb6) SHA1(e5af502c82a907a01eb32618d05c0080a3e4d89d) )
...
ROM_START( kotm2mc )  // --- King of the Monsters 2 (unused)
	ROM_REGION( 0x100000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	//ROM_LOAD( "kotm2mc_0.bin", 0x000000, 0x100000, CRC(ad93f91e) SHA1(caf59d4bde7b9bdd872a46e227eb109a10604423) )
	ROM_LOAD( "kotm2mc_0_fixed.bin", 0x000000, 0x100000, CRC(b2b5d14a) SHA1(ad68eadd4672e80965550c99ab2000d1360bfbf0) )
...
ROM_START( ninjamasmc )
	ROM_REGION( 0x300000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD( "ninjamasmc_0.bin", 0x000000, 0x100000, CRC(c5788e3f) SHA1(cdfc687d93d6e015aa4e7ec49c797926c76f49c3) )
	ROM_LOAD( "ninjamasmc_1.bin", 0x100000, 0x200000, CRC(0044824d) SHA1(901add84780e99841c959e4b2486f97b56df85ba) )
...
GAME( 2003, svcpmc,     neogeo,    neobase, neogeo, mvs_led_state, empty_init, ROT0, "Playmore / Capcom", "SNK vs. Capcom + (161-in-1 multi-cart #001)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, svcrmc,     svcpmc,    neobase, neogeo, mvs_led_state, empty_init, ROT0, "Playmore / Capcom", "SNK vs. Capcom Rmx (161-in-1 multi-cart #002)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, svcspmc,    svcpmc,    neobase, neogeo, mvs_led_state, empty_init, ROT0, "Playmore / Capcom", "SNK vs. Capcom Super Plus (161-in-1 multi-cart #003)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003mc,  neogeo,    neobase, neogeo, mvs_led_state, empty_init, ROT0, "SNK Playmore", "The King of Fighters 2003 (161-in-1 multi-cart #036)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, sonicwi2mc, sonicwi2,  neobase, neogeo, mvs_led_state, empty_init, ROT0, "Video System Co.", "Aero Fighters 2 (161-in-1 multi-cart #048)", MACHINE_SUPPORTS_SAVE )
GAME( 1995, sonicwi3mc, sonicwi3,  neobase, neogeo, mvs_led_state, empty_init, ROT0, "Video System Co.", "Aero Fighters 3 (161-in-1 multi-cart #049)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, samsh5spmc, neogeo,    neobase, neogeo, mvs_led_state, empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special (161-in-1 multi-cart #076)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, pbobblenmc, pbobblen,  neobase, neogeo, mvs_led_state, empty_init, ROT0, "Taito", "Puzzle Bobble (161-in-1 multi-cart #104)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, mutnatmc,   mutnat,    neobase, neogeo, mvs_led_state, empty_init, ROT0, "SNK", "Mutation Nation (161-in-1 multi-cart #117)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, alpham2mc,  alpham2,   neobase, neogeo, mvs_led_state, empty_init, ROT0, "SNK", "Alpha Mission II (161-in-1 multi-cart #119)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, magdrop2mc, magdrop2,  neobase, neogeo, mvs_led_state, empty_init, ROT0, "Data East Corporation", "Magical Drop II (161-in-1 multi-cart #134)", MACHINE_SUPPORTS_SAVE )
GAME( 1991, kotmmc,     kotm,      neobase, neogeo, mvs_led_state, empty_init, ROT0, "SNK", "King of the Monsters (161-in-1 multi-cart #146)", MACHINE_SUPPORTS_SAVE )
GAME( 1990, bjourneymc, bjourney,  neobase, neogeo, mvs_led_state, empty_init, ROT0, "Alpha Denshi Co.", "Blue's Journey (161-in-1 multi-cart #148)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kof2003cmc, kof2003mc, neobase, neogeo, mvs_led_state, empty_init, ROT0, "SNK Playmore", "The King of Fighters 2003 Change (161-in-1 multi-cart #153)", MACHINE_SUPPORTS_SAVE )
GAME( 1997, magdrop3mc, magdrop3,  neobase, neogeo, mvs_led_state, empty_init, ROT0, "Data East Corporation", "Magical Drop III (161-in-1 multi-cart #155)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, wjammersmc, wjammers,  neobase, neogeo, mvs_led_state, empty_init, ROT0, "Data East Corporation", "Windjammers (161-in-1 multi-cart #--- unused)", MACHINE_SUPPORTS_SAVE )
GAME( 1992, kotm2mc,    kotm2,     neobase, neogeo, mvs_led_state, empty_init, ROT0, "SNK", "King of the Monsters 2 (161-in-1 multi-cart #--- unused)", MACHINE_SUPPORTS_SAVE )

GAME( 1996, ninjamasmc, ninjamas, neobase, neogeo, mvs_led_state, empty_init, ROT0, "ADK / SNK", "Ninja Master's (161-in-1 multi-cart #--- new)", MACHINE_SUPPORTS_SAVE )
